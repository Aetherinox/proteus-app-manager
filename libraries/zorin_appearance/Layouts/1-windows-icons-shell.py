...
class WindowsIconsShell(layout.Layout, Gtk.Box):
    ...
    def draw_layout_preview(self, widget, cr):
        ...
        # Menu
        cr.set_line_width(2)
        cr.rectangle(5, layout.LAYOUT_PREVIEW_HEIGHT - 89, 60, 70)
        cr.stroke()

        # Menu icon 1
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 86, 4, 4)
        cr.fill()

        # Menu text 1
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 85, 15, 2)
        cr.fill()

        # Menu icon 2
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 78, 4, 4)
        cr.fill()

        # Menu text 2
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 77, 10, 2)
        cr.fill()

        # Menu icon 3
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 70, 4, 4)
        cr.fill()

        # Menu text 3
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 69, 12, 2)
        cr.fill()

        # Menu icon 4
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 62, 4, 4)
        cr.fill()

        # Menu text 4
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 61, 11, 2)
        cr.fill()

        # Menu icon 5
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 54, 4, 4)
        cr.fill()

        # Menu text 5
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 53, 9, 2)
        cr.fill()

        # Menu icon 6
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 46, 4, 4)
        cr.fill()

        # Menu text 6
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 45, 14, 2)
        cr.fill()

        # Menu icon 7
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 38, 4, 4)
        cr.fill()

        # Menu text 7
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 37, 8, 2)
        cr.fill()

        # Menu icon 8
        cr.rectangle(8, layout.LAYOUT_PREVIEW_HEIGHT - 30, 4, 4)
        cr.fill()

        # Menu text 8
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 29, 10, 2)
        cr.fill()

        # Menu right text 1
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 85, 10, 2)
        cr.fill()

        # Menu right text 2
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 77, 14, 2)
        cr.fill()

        # Menu right text 3
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 69, 8, 2)
        cr.fill()

        # Menu right text 4
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 61, 12, 2)
        cr.fill()

        # Menu right text 5
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 53, 15, 2)
        cr.fill()

        # Menu right text 6
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 45, 11, 2)
        cr.fill()

        # Menu right text 7
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 37, 12, 2)
        cr.fill()

        # Menu right text 8
        cr.rectangle(44, layout.LAYOUT_PREVIEW_HEIGHT - 29, 10, 2)
        cr.fill()
        ...
        # Panel app icon 2
        cr.rectangle(26, layout.LAYOUT_PREVIEW_HEIGHT - 10, 4, 4)
        cr.fill()

        # Panel app icon 3
        cr.rectangle(34, layout.LAYOUT_PREVIEW_HEIGHT - 10, 4, 4)
        cr.fill()
