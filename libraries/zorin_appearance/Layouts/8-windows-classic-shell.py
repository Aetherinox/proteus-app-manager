...
class WindowsClassicShell(layout.Layout, Gtk.Box):
    ...
    def draw_layout_preview(self, widget, cr):
        ...
        # Menu
        cr.set_line_width(2)
        cr.rectangle(5, layout.LAYOUT_PREVIEW_HEIGHT - 83, 32, 70)
        cr.stroke()
        ...
        # Panel app icons
        cr.rectangle(14, layout.LAYOUT_PREVIEW_HEIGHT - 6, 2, 2)
        cr.fill()
        
        cr.rectangle(20, layout.LAYOUT_PREVIEW_HEIGHT - 6, 2, 2)
        cr.fill()
        
        cr.rectangle(26, layout.LAYOUT_PREVIEW_HEIGHT - 6, 2, 2)
        cr.fill()

        # Panel app text 1
        cr.rectangle(32, layout.LAYOUT_PREVIEW_HEIGHT - 6, 32, 2)
        cr.fill()

        # Panel app text 2
        cr.rectangle(68, layout.LAYOUT_PREVIEW_HEIGHT - 6, 32, 2)
        cr.fill()

        # Panel app text 3
        cr.rectangle(104, layout.LAYOUT_PREVIEW_HEIGHT - 6, 32, 2)
        cr.fill()
