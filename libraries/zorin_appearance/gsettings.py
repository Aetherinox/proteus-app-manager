...
class _GSettingsSchema:
        ...
        try:
            ...
            try:
                if global_gettext_domain:
                    ...
                    global_translation = gettext.translation(global_gettext_domain, LOCALE_DIR)
                else:
            ...
            for schema in dom.getElementsByTagName("schema"):
                ...
                try:
                    if gettext_domain:
                        translation = gettext.translation(gettext_domain, LOCALE_DIR)
                    else:
    ...
    def __repr__(self):
        return "<zorin-appearance.gsettings._GSettingsSchema: %s>" % self._schema_name
